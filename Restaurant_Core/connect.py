...
# Read the JSON file
with open("C:/TEST FINAL YEAR/changed_data_rating.json",encoding="utf-8") as f:
    data = json.load(f)
...
for i,restaurant in enumerate(data):
    ...
    cur.execute(
        "INSERT INTO restaurant_userprofile (user_id, is_owner,last_rated,new_rated) VALUES (%s,%s,%s,%s)",
        (user_id,True,datetime.timezone.utc,False)
    )
    cur.execute(
